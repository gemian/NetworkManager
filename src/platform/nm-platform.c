...
gboolean
nm_platform_wpan_set_pan_id (NMPlatform *self, int ifindex, const guint16 pan_id)
{
	_CHECK_SELF (self, klass, FALSE);
...
gboolean
nm_platform_wpan_set_short_addr (NMPlatform *self, int ifindex, const guint16 short_addr)
{
	_CHECK_SELF (self, klass, FALSE);
